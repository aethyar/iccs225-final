...
CREATE OR REPLACE PROCEDURE update_food_info(cur_food_id INT, new_name VARCHAR(100), new_description TEXT,
                                             new_category VARCHAR(50), new_cost DECIMAL(10, 2),
                                             new_img_link VARCHAR(255))
    LANGUAGE plpgsql AS
$$
BEGIN
    UPDATE "foods"
...
CREATE OR REPLACE PROCEDURE update_ingredient_info(cur_ingredient_id INT, new_name VARCHAR(100), new_description TEXT,
